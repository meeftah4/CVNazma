...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .name { font-size: 28px; font-weight: 700; color: black; }
        .title { font-size: 18px; font-weight: 500; margin-top: 5px; }
        .contact { text-align: right; font-size: 14px; line-height: 1.6; }
        section { margin-bottom: 25px; }
        h2 { font-size: 18px; color: black; margin-bottom: 8px; border-bottom: 1px solid #ccc; padding-bottom: 4px; font-weight: 600; }
