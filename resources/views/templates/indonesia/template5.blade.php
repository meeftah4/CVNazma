    ...
    @foreach ($proyek as $item)
      <div class="mb-3">
        <div style="display:flex; justify-content:space-between; align-items:center;">
          ...
          <span class="italic" style="font-size:0.98rem;">{{ $item['startDate'] ?? 'Jan 2023' }} - {{ $item['endDate'] ?? 'Jun 2023' }}</span>
        </div>
    ...
    @foreach ($pendidikan as $edu)
      <div class="mb-3">
        <div style="display:flex; justify-content:space-between; align-items:center;">
          ...
          <span class="italic" style="font-size:0.98rem;">{{ $edu['startDate'] ?? 'Jan 2024' }} - {{ $edu['endDate'] ?? 'Jan 2025' }}</span>
        </div>
