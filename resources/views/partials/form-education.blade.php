{{-- filepath: d:\Magang\CVNazma\resources\views\partials\form-education.blade.php --}}
<div class="space-y-3">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-2">
            <button type="button" onclick="saveEducation()" class="bg-orange-400 hover:bg-orange-500 text-white px-4 py-2 rounded">Simpan</button>
        </div>
    </div>
</div>