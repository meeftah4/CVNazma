...
<div id="hobiList" class="mb-4 break-words">
...
<div id="hobiForm" class="bg-white p-4 rounded-b-md rounded-t-none border-t-0">
    ...
    <button type="button"  onclick="saveDataHobi()" class="px-4 py-2 rounded-md font-semibold flex items-center" style="background-color: #FFBC5D; color: #01287E; gap: 0.25rem;">
