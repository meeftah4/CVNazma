...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Ambil data dari sessionStorage, bukan backend
        let data = {};
        try {
            data = JSON.parse(window.sessionStorage.getItem('cv_tempdata') || '{}');
        } catch (e) { data = {}; }
        ...
        // Render ulang semua data step 2 dari sessionStorage
