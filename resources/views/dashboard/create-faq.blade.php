...
<div class="faq-form-container">
    ...
    <form action="{{ route('faq.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="question" name="question" value="{{ old('question') }}" class="faq-form-input" placeholder="Masukkan pertanyaan">
            @error('question')
        ...
        <div class="mb-4">
            ...
            <textarea id="answer" name="answer" rows="4" class="faq-form-textarea" placeholder="Masukkan jawaban">{{ old('answer') }}</textarea>
            @error('answer')
                <div class="faq-form-error">{{ $message }}</div>
            @enderror
        </div>
